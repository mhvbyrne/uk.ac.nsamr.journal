...
<div class="row">
    <div class="col-sm-12">
        <div class="left-heading">Online submission</div>
        <div>
            <p>Authors must register with JNSAMR before they can submit articles online.</p>
			<p style="color:red;">Register (HYPERLINKS XX)</p>
			<p>Already Registered?</p>
			<p style="color:red;">Login (HYPERLINKS XX)</p>
		</div>	
    </div>                       
</div>
<hr>
...
<div class="row">
    <div class="col-sm-12">
        <div class="left-heading">Eligability</div>
        <div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="left-heading">Authorship</div>
        <div>
